                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <form action="{{url('/company.update/'.$data->id)}}" method="post">
                                        @csrf
                                    <div class="form-group row">
                                        <label for="text" class="col-12 col-form-label">Enter Title here</label> 
                                        <div class="col-12">
                                        <input id="text" name="title" value= "{{$data->title}}" class="form-control " required="required" type="text">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                        <input id="text" name="ad" value= "{{$data->ad}}"  class="form-control here" required="required" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="file" class="col-12 col-form-label">Upload video</label> 
                                        <div class="col-12">
                                        <input class="browse-input" type="file" name="video" value= "{{$data->video}}" required name="UploadedFile" id="UploadedFile"/>
                                        </div>
                                    </div> 
