...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            a{color:white;text-decoration:inherit}svg,video{display:block;vertical-align:middle}video{max-width:100%;height:auto}
    ...
    <body>
        ...
        <!-- <div class="fixedheader"> -->
            <!-- <h1><b><u>Jobs for Retiree</u></b></h1> -->
            <nav>
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @auth
                         <a href="{{ url('/dashboard') }}" class="text-m text-white-900 dark:text-white-500 underline">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-m text-white-900 dark:text-white-500 underline">Log in</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 text-m text-white-900 dark:text-white-500 underline">Register</a>
                    @endif
                    @endauth
        ...
        <!-- </div> -->
            <div class="container">  
                    ...
                    <img src="/cover/cp.jpg" alt="cover image" width:90%>
